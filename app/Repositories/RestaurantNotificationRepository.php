...
use App\Models\RestaurantPushNotification;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;

class RestaurantNotificationRepository implements RestaurantNotificationRepositoryInterface
{
    public function __construct(
        private readonly RestaurantPushNotification $notification,
    ) {}
