...
class RestaurantRepository implements RestaurantRepositoryInterface
{
    ...
    {
        return $this->restaurant->with($relations)->where($params)->first();
    }
    ...
    {
        $query = $this->restaurant->with($relations)->when(!empty($orderBy), function ($query) use ($orderBy) {
    ...
    public function getListWhere(
        ...
        $query = $this->restaurant->select($select)->with($relations)
    ...
    {
        return $this->restaurant->whereNotIn('id', $ids)->get();
    }

    public function update(string $id, array $data): bool
    {
        return $this->restaurant->find($id)->update($data);
    }

    public function updateWhere(array $params, array $data): bool
    {
        $this->restaurant->where($params)->update($data);
        return true;
    }

    public function updateOrCreate(array $params, array $data): mixed
    {
        return $this->restaurant->updateOrCreate($params, $data);
    }

    public function delete(array $params): bool
    {
        $this->restaurant->where($params)->delete();
        return true;
    }

    public function getRestaurantNameList(object $request, int|string $dataLimit = DEFAULT_DATA_LIMIT): object
    {
        $searchValue = explode(' ', $request['searchValue']);
        return $this->restaurant->where('id', '!=', 0)
