...
@section('title', translate('Notification Preferences'))
...
<div class="content container-fluid">
    <div class="main-content">
        ...
        <form action="{{ route('expert.settings.notifications.update') }}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="text-center">{{ translate('Dashboard') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($preferences as $pref)
                                @php
                                $label = str_replace('_', ' ', ucwords($pref->type, '_'));
                                @endphp
                                <tr>
                                    <td class="font-weight-bold">{{ translate($label) }}</td>
                                    <td class="text-center">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                name="notifications[{{ $pref->type }}][email]"
                                                {{ $pref->email ? 'checked' : '' }}>
                                    ...
                                    <td class="text-center">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                name="notifications[{{ $pref->type }}][sms]"
                                                {{ $pref->sms ? 'checked' : '' }}>
                                            <span class="switcher_control"></span>
                                        </label>
                                    </td>
                                    <td class="text-center">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                name="notifications[{{ $pref->type }}][dashboard]"
                                                {{ $pref->dashboard ? 'checked' : '' }}>
                                            <span class="switcher_control"></span>
                                        </label>
                                    </td>
                                </tr>
