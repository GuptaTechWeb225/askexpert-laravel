...
<div class="content container-fluid">
    ...
    <div class="row gx-2 gx-lg-3">
        <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('restaurant.notification.index')}}" method="post" class="text-start"
                    ...
                    <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('restaurant.notification.update-status')}}" method="post"
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a class="btn btn-outline--primary btn-sm edit square-btn"
                                            ...
                                            href="{{route('restaurant.notification.update',[$notification['id']])}}">
                                            <i class="tio-edit"></i>
                                        </a>
                                        <a class="btn btn-outline-danger btn-sm delete-data-without-form"
                                            title="{{translate('delete')}}"
                                            data-action="{{route('restaurant.notification.delete')}}"
                                            data-id="{{$notification['id']}}')">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        // increment notification count on UI
                        let countId = $('#count-' + id);
                        countId.text(parseInt(countId.text()) + 1);
                    } else {
                        // quota khatam ya koi error
                        toastr.error(response.message + (response.pushes_left !== undefined ? ' (Pushes left: ' + response.pushes_left + ')' : ''), { CloseButton: true, ProgressBar: true });
                    }
                },
                error: function(xhr) {
