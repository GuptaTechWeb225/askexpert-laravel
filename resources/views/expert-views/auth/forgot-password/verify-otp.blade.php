        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="card py-2 mt-4">
                    <form class="card-body needs-validation otp-form" action="{{route('expert.auth.otp-verification')}}"
                          method="post">
                        @csrf
                        <div class="form-group">
                            <div class="text-center">
                                <img src="{{asset('assets/front-end/img/icons/otp-login-icon.svg')}}" width="50" height="50" alt="" class="mb-4">
                            </div>
