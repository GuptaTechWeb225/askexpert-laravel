...
<head>
    ...
    <link href="{{ asset('public/assets/back-end/plugins/summernote/summernote.min.css') }}" rel="stylesheet">
...
<script src="{{dynamicAsset(path: 'public/assets/back-end/js/sweet_alert_new.js')}}"></script>
