...
@section('title', translate('after_login_page'))
    ...
    <div class="content container-fluid">
        ...
        <div class="inline-page-menu my-4">
            <ul class="list-unstyled">
                ...
                <li class="{{ $currentType == $key ? 'active' : 'text-dark' }}">
                    <a href="{{ route('admin.content-management.after-login', ['section' => $key]) }}"
        ...
        <div class="card">
            ...
            <div class="card-body p-3">
                @include("admin-views.content-management.after-login.partials.{$currentType}")
            </div>
        </div>
    </div>
</section>
...
<script>
    ...
    window.openModal = function(section, itemId = 0, isAdd = false) {
        ...
        $('#editForm').attr('action', `{{ url('admin/after-login-cms') }}/${section}/${itemId}`);

        $.get(`{{ url('admin/after-login-cms/edit-data') }}/${section}/${itemId}`, function(html) {
            $('#modalBody').html(html);
            modal.show();
        });
    };
