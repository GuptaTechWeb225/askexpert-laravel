@php $hero = app('App\Http\Controllers\Admin\Cms\AfterLoginCmsController')->getSectionData('my_experts')->first(); @endphp
        ...
        <tbody>
            <tr>
                ...
                <td class="text-nowrap">
                    <button onclick="openModal('my_experts', 2)" class="btn btn-sm btn-primary"> <i class="tio-edit"></i>
                    </button>
                </td>
            </tr>
        </tbody>
