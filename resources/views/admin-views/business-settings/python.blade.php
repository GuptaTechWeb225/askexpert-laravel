...
@section('title', translate('python_api_config'))
...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.pythonapi.update') }}" method="post"
                            ...
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color d-flex text-capitalize"
                                           for="stock_limit">{{translate('python_api')}}</label>
                                </div>
                                <input class="form-control" type="text" name="base_url_python" id="python_api_config"
                                       value="{{ $baseUrl['value'] }}"
                                       placeholder="{{translate('ex').':'.'http://127.0.0.1:8000'}}">
                            </div>
                        </div>
