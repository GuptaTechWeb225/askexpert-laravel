...
<div class="content container-fluid">
    ...
    <div class="col-12 col-md-6 col-lg-3 mb-4">
        <a class="business-analytics card">
            ...
            <div class="mt-2 d-flex justify-content-between align-items-center">
                <h2 class="business-analytics__title">{{ $totalUsers }}</h2>
                <img src="{{dynamicAsset('public/assets/back-end/img/categories/customer-icon-1.png')}}" width="40">
            </div>
        </a>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-3 mb-4">
        <a class="business-analytics card">
            <h5 class="business-analytics__subtitle">Active Users</h5>
            <div class="mt-2 d-flex justify-content-between align-items-center">
                <h2 class="business-analytics__title">{{ $activeUsers }}</h2>
                <img src="{{dynamicAsset('public/assets/back-end/img/categories/customer-icon-2.png')}}" width="40">
            </div>
        </a>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-3 mb-4">
        <a class="business-analytics card">
            <h5 class="business-analytics__subtitle">Blocked Users</h5>
            <div class="mt-2 d-flex justify-content-between align-items-center">
                <h2 class="business-analytics__title">{{ $blockedUsers }}</h2>
                <img src="{{dynamicAsset('public/assets/back-end/img/categories/customer-icon-3.png')}}" width="40">
            </div>
        </a>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-3 mb-4">
        <a class="business-analytics card">
            <h5 class="business-analytics__subtitle">Questions Asked</h5>
            <div class="mt-2 d-flex justify-content-between align-items-center">
                <h2 class="business-analytics__title">{{ $totalQuestions }}</h2>
                <img src="{{dynamicAsset('public/assets/back-end/img/categories/admin-dash-card-2.png')}}" width="40">
            </div>
        </a>
    </div>
</div>
        ...
        <div class="card-body">
            <form action="{{ url()->current() }}" method="GET">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label class="form-label">{{translate('User_Joining_Date')}}</label>
                    ...
                    <div class="col-md-4">
                        <label class="form-label">{{translate('User_Status')}}</label>
            ...
            <table
                ...
                <thead class="thead-light thead-50 text-capitalize">
                    <tr>
                        ...
                        <th>{{translate('Total Questions')}} </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="btn text-info bg-soft-info font-weight-bold px-3 py-1 mb-0 fz-12">
                                {{$customer->totalChatSessions() ?? 0}}
                            </label>
                        </td>
                        <td>
                            {{ $customer->created_at ? $customer->created_at->format('d M Y, h:i A') : 'Inactive' }}
                        </td>
                        <td>
