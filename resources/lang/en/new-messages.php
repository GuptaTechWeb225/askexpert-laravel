...
return [
	...
	"icon_class (e.g. fa-heart)" => "Icon class (e.g. fa-heart)",
	"Edit Perk" => "Edit Perk",
	"Edit :section" => "Edit :section",
	"Edit Benifits" => "Edit Benifits",
	"Edit Benefits" => "Edit Benefits",
	"Invalid data or job not found." => "Invalid data or job not found.",
	...
	"User_list" => "User list",
	"User_Joining_Date" => "User Joining Date",
	...
	"Restaurant_Joining_Date" => "Restaurant Joining Date",
	...
	"Plan_type" => "Plan type",
	"if_enabled_this_restaurant_will_be_unblocked_and_can_log_in_to_this_system_again" => "If enabled this restaurant will be unblocked and can log in to this system again",
	"if_disabled_this_restaurant_will_be_blocked_and_cannot_log_in_to_this_system" => "If disabled this restaurant will be blocked and cannot log in to this system",
	"Restaurant_deleted_successfully" => "Restaurant deleted successfully",
	"No_Restaurant_found" => "No Restaurant found",
	"search_by_Name_or_Email_or_Phone_or_city" => "Search by Name or Email or Phone or city",
	"customer_Not_Found" => "Customer Not Found",
	...
	"View_gst_copy" => "View gst copy",
	"View_tax_copy" => "View tax copy",
	"View_fssai_copy" => "View fssai copy",
	"View_pan_copy" => "View pan copy",
	"Restaurant_Address" => "Restaurant Address",
	"state" => "State",
	" zip_code" => " zip code",
	"Working Hours" => "Working Hours",
	"MAP_Location" => "MAP Location",
	"Restaurant_Requests" => "Restaurant Requests",
	"tax_number" => "Tax number",
	"Restaurant_approved_successfully" => "Restaurant approved successfully",
	...
	"Restaurant Media & Features" => "Restaurant Media & Features",
	"Features" => "Features",
	...
	"user_Analytics" => "User Analytics",
	"Top Performing Restaurant" => "Top Performing Restaurant",
	...
	"plan_SKU" => "Plan SKU",
	"create_a_unique_plan_code_by_clicking_on_the_Generate_Code_button" => "Create a unique plan code by clicking on the Generate Code button",
	"select duraton of plan like 60 days 90 days 365 days" => "Select duraton of plan like 60 days 90 days 365 days",
	"select expiry reminders days for reminder before plan expire" => "Select expiry reminders days for reminder before plan expire",
	"enter how much notification can send by this plan " => "Enter how much notification can send by this plan ",
	"enter how much days the resturant can show in top" => "Enter how much days the resturant can show in top",
	"enter how much mail can send by this plan" => "Enter how much mail can send by this plan",
	"select multiple addons feture for this plan" => "Select multiple addons feture for this plan",
	...
	"if_enabled_this_plan_will_be_avilable_and_show_to_this_system" => "If enabled this plan will be avilable and show to this system",
	"if_disabled_this_plan_will_be_offline_and_hide_to_this_system" => "If disabled this plan will be offline and hide to this system",
	"Plan_List" => "Plan List",
	"Plan_deleted_successfully" => "Plan deleted successfully",
	"Plan code must be unique." => "Plan code must be unique.",
	"plan_updated_successfully" => "Plan updated successfully",
	"boost_Plan" => "Boost Plan",
	"Boost Plan" => "Boost Plan",
	"Create Boost Plan" => "Create Boost Plan",
	"Username is required!" => "Username is required!",
	"The selected boost type is invalid." => "The selected boost type is invalid.",
	"Boosts duration is required." => "Boosts duration is required.",
	"count  is required." => "Count is required.",
	"count" => "Count",
	"Restaurant Images" => "Restaurant Images",
	"Plan Transaction" => "Plan Transaction",
	"Plans Transactions" => "Plans Transactions",
	"No_Transaction_found" => "No Transaction found",
	...
	"purchase_date" => "Purchase date",
	"expiry_date" => "Expiry date",
	"if_enabled_this_plan_will_be_avilable_and_restaurant_can_use_it" => "If enabled this plan will be avilable and restaurant can use it",
	"if_disabled_this_plan_will_be_offline_for_this_restaurant" => "If disabled this plan will be offline for this restaurant",
	"Reminder_Days_Left" => "Reminder Days Left",
	"if_enabled_this_plan_will_be_available_and_restaurant_can_use_it" => "If enabled this plan will be available and restaurant can use it",
	"Last_visit" => "Last visit",
	"Point_earned" => "Point earned",
	"Point_redem" => "Point redem",
	"repeat_visit" => "Repeat visit",
	"booking_cancelled" => "Booking cancelled",
	"Fainal_ammount" => "Fainal ammount",
	"Rewards Given" => "Rewards Given",
	"redemption_rate" => "Redemption rate",
	"redemption_statistics" => "Redemption statistics",
	"Total_redemptions" => "Total redemptions",
	"avg_Bill_Value" => "Avg Bill Value",
	...
	"Plan_transactions" => "Plan transactions",
	"Total_Plan_Ammount" => "Total Plan Ammount",
	"Transaction_Id" => "Transaction Id",
	"plan_Analytics" => "Plan Analytics",
	"Transaction_Analytics" => "Transaction Analytics",
	"Login And View Your" => "Login And View Your",
	"Analytics..." => "Analytics...",
	...
	"campaigns" => "Campaigns",
	"campaigns_Impact" => "Campaigns Impact",
	"create_Campaigns" => "Create Campaigns",
	"Rewards_Section" => "Rewards Section",
	"reward_Performance" => "Reward Performance",
	"Reward_Performance" => "Reward Performance",
	"Visits" => "Visits",
	...
	"Transaction_list" => "Transaction list",
	"rewards_Performance" => "Rewards Performance",
	...
	"Please give any rating " => "Please give any rating ",
	"Customer Reviews" => "Customer Reviews",
	"Prev" => "Prev",
	"Mam" => "Mam",
	"boost" => "Boost",
	"want_to_boost" => "Want to boost",
	"want_to_normal" => "Want to normal",
	"if_enabled_this_restaurant_will_be_show_on_the_top_of_the_restaurants" => "If enabled this restaurant will be show on the top of the restaurants",
	"if_disabled_this_restaurant_will_be_show_in_normal" => "If disabled this restaurant will be show in normal",
	"Forbidden" => "Forbidden",
	"Access Denied: Your plan has no customer addon" => "Access Denied: Your plan has no customer addon",
	"Access Denied: Your plan has no Reward addon" => "Access Denied: Your plan has no Reward addon",
	"Access Denied: Your plan has no Transaction Analytics" => "Access Denied: Your plan has no Transaction Analytics",
	"Access Denied: Your plan has no Reward Analytics" => "Access Denied: Your plan has no Reward Analytics",
	"Access Denied: Your plan has no customer Analytics" => "Access Denied: Your plan has no customer Analytics",
	"Boost_Restaurant" => "Boost Restaurant",
	"firebase_configuration_Setup" => "Firebase configuration Setup",
	"send_to" => "Send to",
	"sent_to_is_required" => "Sent to is required",
	...
	"body" => "Body",
	"Flat 200 off on order above 2000" => "Flat 200 off on order above 2000",
	"All Customers" => "All Customers",
	"Selected Customers" => "Selected Customers",
	"select_customers" => "Select customers",
	"add_new_mail" => "Add new mail",
	"Sent" => "Sent",
	"Mail has been queued for sending." => "Mail has been queued for sending.",
	"Boost" => "Boost",
	"boost_Table" => "Boost Table",
	"You do not have enough mails left in your plan." => "You do not have enough mails left in your plan.",
	"Mail queued for 1 customers." => "Mail queued for 1 customers.",
	"You do not have enough mails left in your plan. Buy an addon email plan for this feature" => "You do not have enough mails left in your plan. Buy an addon email plan for this feature",
	"You do not have any push notifications left in your plan." => "You do not have any push notifications left in your plan.",
	"Notitfication" => "Notitfication",
	"push_notification_failed" => "Push notification failed",
	"Email_sent_successfully." => "Email sent successfully.",
	"Email_configuration_issue." => "Email configuration issue.",
	"Invalid_data" => "Invalid data",
	"Invalid_credentials_or_expired_link" => "Invalid credentials or expired link",
	"restaurant_List" => "Restaurant List",
	"restaurant_Analytics" => "Restaurant Analytics",
	"restaurant_plan" => "Restaurant plan",
	...
	"plan_type" => "Plan type",
	"Give_new_password_to_reset_restaurant_password" => "Give new password to reset restaurant password",
	...
	"Access Denied! Please buy paid plans to login in dashboard." => "Access Denied! Please buy paid plans to login in dashboard.",
	...
	"Phone number may not be greater than 20 characters" => "Phone number may not be greater than 20 characters",
	...
	"edit_expert_category" => "Edit expert category",
	"edit_category" => "Edit category",
	"add_expert_category" => "Add expert category",
	"category_details" => "Category details",
	"recommended_size_100x100" => "Recommended size 100x100",
	"free_follow_up_duration" => "Free follow up duration",
	...
	"cms_image" => "Cms image",
	"recommended_size_1200x600" => "Recommended size 1200x600",
	"cms_description" => "Cms description",
	"enter_category_name" => "Enter category name",
	"e.g._Cardiologist" => "E.g. Cardiologist",
	"brief_description_about_this_expert_category" => "Brief description about this expert category",
	"e.g._7" => "E.g. 7",
	"e.g._Expert_Cardiology_Services" => "E.g. Expert Cardiology Services",
	"detailed_description_for_website_landing_page" => "Detailed description for website landing page",
	"e.g._Heart_Checkup" => "E.g. Heart Checkup",
	"add_multiple_sub_categories_for_this_expert_type" => "Add multiple sub categories for this expert type",
	"separate_with_comma" => "Separate with comma",
	"e.g._Heart_Checkup,_Blood_Pressure,_ECG" => "E.g. Heart Checkup  Blood Pressure  ECG",
	"Expert category created successfully" => "Expert category created successfully",
	"Status updated" => "Status updated",
	"joining_Fee" => "Joining Fee",
	"monthly_Fee" => "Monthly Fee",
	"expert_Fee" => "Expert Fee",
	"Categories & Pricing" => "Categories & Pricing",
	"Expert category updated successfully" => "Expert category updated successfully",
	"Expert category deleted successfully" => "Expert category deleted successfully",
	"No_Data_Found" => "No Data Found",
	"Active_Experts" => "Active Experts",
	"search_by_Name" => "Search by Name",
	"Select Category" => "Select Category",
	"total_categories" => "Total categories",
	"Custom Pricing Enabled" => "Custom Pricing Enabled",
	"Default Pricing Applied" => "Default Pricing Applied",
	...
	"Expert" => "Expert",
	"Mode" => "Mode",
	"no_Question_history_found" => "No Question history found",
	"search_Question" => "Search Question",
	"Prices" => "Prices",
	"No quick buttons added yet" => "No quick buttons added yet",
	"Ask" => "Ask",
	"Things" => "Things",
	...
	"Expert_Applications" => "Expert Applications",
	"No_requests_found" => "No requests found",
	"Expert_Joining_Date" => "Expert Joining Date",
	"Expert_application_approved_successfully" => "Expert application approved successfully",
	"Expert_application_rejected_successfully" => "Expert application rejected successfully",
	"Experts" => "Experts",
	"Join_Date" => "Join Date",
	"if_enabled_this_expert_will_be_unblocked_and_can_log_in_to_this_system_again" => "If enabled this expert will be unblocked and can log in to this system again",
	"if_disabled_this_expert_will_be_blocked_and_cannot_log_in_to_this_system" => "If disabled this expert will be blocked and cannot log in to this system",
	"expert_Status" => "Expert Status",
	"Total Experts" => "Total Experts",
	"Online Expert Now" => "Online Expert Now",
	"Pending Applications" => "Pending Applications",
	"Blocked Experts" => "Blocked Experts",
	"expert_Login" => "Expert Login",
	"Not_approve_yet" => "Not approve yet",
	"Account_Not_approve_yet" => "Account Not approve yet",
	"Your_account_is_reject_by_admin" => "Your account is reject by admin",
	"category_card_details" => "Category card details",
	"card_title" => "Card title",
	"card_image" => "Card image",
	"<?php echo e($categorie->name); ?>" => "  php echo e($categorie- name)    ",
];
