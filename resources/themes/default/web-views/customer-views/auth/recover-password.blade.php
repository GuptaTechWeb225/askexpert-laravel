        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 text-start">
                ...
                <div class="card py-2 mt-4">
                    <form class="card-body needs-validation" action="{{route('customer.auth.forgot-password-send')}}"
                          method="post">
                        @csrf
                        <div class="form-group">
                            <label for="recover-email">
                                {{ translate('Email') }}
                            </label><span class="fs-12 text-muted">*</span>

                            <input class="form-control clean-phone-input-value" type="email" name="email" required
