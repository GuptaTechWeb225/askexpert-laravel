    ...
    return [
        ...
        'categorie_view' => 'web-views.pages.categorie-view',
        'user_home' => 'web-views.pages.user-home',
        'user_questions' => 'web-views.pages.user-questions',
        'user_experts' => 'web-views.pages.user-experts',
        'refund_policy_page' => 'web-views.pages.refund-policy',
        'return_policy_page' => 'web-views.pages.return-policy',
        'chat_bot' => 'web-views.pages.chat-bot',
        'help' => 'web-views.pages.help',
        'knowledge_all' => 'web-views.pages.knowledge',
        'knowledge_read' => 'web-views.pages.knowledge-read',
        'become_expert' => 'web-views.pages.become-expert',
        'cms_price' => 'web-views.pages.price',
        ...
        'reset_password_expire' => 'web-views.customer-views.auth.reset-password-expire',
        'reset_password_update' => 'web-views.customer-views.auth.reset-password-update',
        'wallet_account' => '',
        ...
        'expert_register' => 'web-views.expert.register',
        'account_notifications' => 'web-views.users-profile.account-notifications',
        'user_plan' => 'web-views.users-profile.plans',
        'my_experts' => 'web-views.users-profile.user-expert',
        'my_questions' => 'web-views.users-profile.user-questions',
